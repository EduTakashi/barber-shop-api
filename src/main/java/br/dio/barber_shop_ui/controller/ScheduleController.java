package br.dio.barber_shop_ui.controller;

import br.dio.barber_shop_ui.controller.request.SaveScheduleRequest;
import br.dio.barber_shop_ui.controller.response.SaveScheduleResponse;
import br.dio.barber_shop_ui.controller.response.ScheduleAppointmentMonthResponse;
import br.dio.barber_shop_ui.mapper.IScheduleMapper;
...
public class ScheduleController {
    ...
    ScheduleAppointmentMonthResponse listMonth(@PathVariable final int year,@PathVariable final int month){
        ...
        var startAt = yearMonth.atDay(1).atTime(0,0,0,0)
                .atOffset(UTC);
